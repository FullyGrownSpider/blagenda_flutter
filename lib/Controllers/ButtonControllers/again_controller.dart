...
class AgainYearController extends SkippableEndBasedController<AgainYearDay> {
  ...
  @override
  bool isImportantDate(int fromNow) {
    return isHappeningOnDayFromNow(fromNow);
  }
}
...
class AgainWeekController extends SkippableEndBasedController<AgainWeekDay> {
  ...
  void create() {
    ...
    startedChecking(() {
      ...
      dateController =
          startDate!.add(Duration(days: weekdaysForCalc - startDate!.weekday));
  ...
  @override
  bool isImportantDate(int fromNow) {
    return startDate != null && startDate!.daysLeftUntil() == fromNow;
  }
}
...
class AgainMonthController extends SkippableEndBasedController<AgainMonthDay> {
  ...
  bool isLastTime() =>
      endingDate != null &&
      endingDate!.isBefore(
          MyDateController(dateController.year, dateController.month + 1, day));
  ...
  @override
  bool isImportantDate(int fromNow) {
    return day > 10 && isHappeningOnDayFromNow(fromNow) ||
        startDate != null && startDate!.daysLeftUntil() == fromNow;
  }
}
